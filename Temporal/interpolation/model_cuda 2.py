...
class T_RED_GNN(nn.Module):
    ...
    def forward(self, batch, mode='train'):
        ...
        # h0 = torch.zeros((1, self.hidden_dim), device=self.device)
        ...
        for i in range(self.n_layer):
            ...
            # hidden_embedding = torch.sigmoid(self.dropout(hidden_embedding))
            hidden_embedding = F.softplus(hidden_embedding)
            # hidden_embedding, h0 = self.gate(hidden_embedding, h0)
