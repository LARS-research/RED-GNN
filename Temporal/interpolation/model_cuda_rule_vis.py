...
class T_RED_GNN(nn.Module):
    ...
    def forward(self, batch, mode='train'):
        ...
        source_ent, target_ent, rel_name = f'{self.get_data(entity.item(), "entity")}_0', f'{self.get_data(batch["tail"].item(), "entity")}_{self.n_layer}', f'{self.get_data(query_rel.item(), "relation")}_{self.get_data(query_time.item(), "time")}'
